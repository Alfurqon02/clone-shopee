                            ...
                            <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s"
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <p>Shop smart, shop effortlessly. Explore trending products, enjoy exclusive deals, and experience seamless checkout with our user-friendly e-commerce app. Elevate your online shopping journey today!
                                        </p>
                                    </div>
                                    <div class="col-lg-12">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3" style="flex: 0 0 25%; box-sizing: border-box; margin-bottom: 1%;">
                    <div class="service-item first-service" style="display: flex; flex-direction: column; height: 100%; border: 1px solid #ccc; margin-bottom: 20px;">
                            {{-- <div class="icon"></div> --}}
                            <h4>{{ $category->name }}</h4>
