    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <a href="index.html" class="app-brand-link">
                <span class="app-brand-logo demo">
                    <span style="color: var(--bs-primary)">
                        ...
                        <img width="50" height="50" viewBox="250 250 250 250" src="{{ asset('assets/images/myshoppu-logo.png') }}" alt="">
                    </span>
                </span>
                <span class="app-brand-text demo menu-text fw-semibold ms-2">MyShoppu</span>
            </a>
        ...
        <ul class="menu-inner py-1">
            <!-- Dashboards -->
            <li class="menu-item {{ request()->is('home*') || request()->is('product*') || request()->is('cart*') || request()->is('history*') ? 'open' : '' }}"">
                ...
                <ul class="menu-sub">
                    <li class="menu-item {{ request()->is('home*') ? 'active' : '' }}">
                        <a href="{{ route('my.home') }}" class="menu-link ">
                            <div data-i18n="Home">Home</div>
                        </a>
                    </li>
                    <li class="menu-item {{ request()->is('product*') ? 'active' : '' }}">
                        <a href="{{ route('my.item') }}" class="menu-link ">
                            <div data-i18n="Product">Product</div>
                        </a>
                    </li>
                    <li class="menu-item {{ request()->is('cart*') ? 'active' : '' }}">
                        <a href="{{ route('my.cart') }}" class="menu-link">
                            <div data-i18n="Cart">Cart</div>
                        </a>
                    </li>
                    <li class="menu-item {{ request()->is('history*') ? 'active' : '' }}">
                        <a href="{{ route('my.history') }}" class="menu-link">
            ...
            <!-- Settings -->
            <li class="menu-item {{ request()->is('account*') || request()->is('income*') ? 'open' : '' }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <li class="menu-header fw-medium mt-4">
                <span class="menu-header-text">Administrator Menu</span>
            </li>
            <!-- Pages -->
            <li class="menu-item {{ request()->is('admin/account*') || request()->is('admin/notification*') ? 'open' : '' }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <li class="menu-item {{ request()->is('admin/product*') || request()->is('admin/category*') ? 'open' : '' }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons mdi mdi-cube-outline"></i>
                    <div data-i18n="Item Settings">Item Settings</div>
                </a>
                <ul class="menu-sub">
