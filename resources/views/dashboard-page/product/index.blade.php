                    ...
                    <tbody>
                        @foreach ($items as $item)
                            <tr>
                                ...
                                <th>
                                    <div>
                                        <a style="border: transparent" href="#" class="badge bg-label-info"><i class="mdi mdi-eye"></i></a>
                                        <a style="border: transparent" href="{{ route('edit.item', $item->slug) }}" class="badge bg-label-warning"><i class="mdi mdi-pencil"></i></a>
                                        <button style="border: transparent" data-bs-toggle="modal" data-id={{ $item->id }} data-bs-target="#backDropModalDelete" class="badge bg-label-danger"><i class="mdi mdi-delete"></i></button>
                                    </div>
                                </th>
                            </tr>
                        @endforeach
